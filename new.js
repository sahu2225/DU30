...
const CONTRACT_ADDRESS = "0x328c1fD9ca899e5547e0ca2d8c1AF972C5f91834";
...
async function main() {
  ...
  console.log(`No of tot trans: ${swapCount.toString()}`);
  console.log(`No of wallet holder: ${uniqueSwappers.toString()}`);
  console.log(`Time Until Next Withdraw: ${hours} hours ${minutes} minutes`);
